...
<?php
	...
	$results = mysqli_query( $connect, "SELECT * FROM patient_form WHERE patient_id =$p_id" )
		or die("Can not execute query");

	echo "<table class='ui celled striped unstackable  collapsing table' style='margin: 0 auto;'> \n";
	echo "<thead><tr><th>patient_id</th> <th>patient_name</th> <th>patient_age</th> <th>patient_gender</th> <th>patient_contact</th> <th>patient_email</th> <th>patient_address</th> <th>p_d_id</th> <th>p_h_id</th> <th>patient_organ_id</th> </tr> </thead>  <tbody> \n";
